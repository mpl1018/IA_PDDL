...
(:action asignMediaToDay
    ...
    :precondition 
    (and (< (dayAssignmentCount ?d) 3) (wantToWatch ?a) (not (mediaAsigned ?a)) (<= (- (dayNum ?d) (firstDayParallelAssignment ?a)) 1)
        (forall (?x - media) 
            (and 
    ...
    :effect 
    (and 
        (increase (dayAssignmentCount ?d) 1) (mediaAsignedToDay ?a ?d) (mediaAsigned ?a)
        (forall (?x - media) 
            (when 
